...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
var pizzaCheff = /*#__PURE__*/function () {
  function pizzaCheff() {
    _classCallCheck(this, pizzaCheff);
  ...
  _createClass(pizzaCheff, [{
    key: "isPhoneValid",
    value: function isPhoneValid(phone) {
    ...
    key: "checkForDots",
    value: function checkForDots() {
      var val = this.usernameEl.value.replace(/[.]/g, '');
      this.usernameEl.value = val;
    }
  }, {
    key: "checkIfNumbersOnly",
    value: function checkIfNumbersOnly() {
      var val = this.phoneEl.value.replace(/\D/g, '');
      this.phoneEl.value = val;
    }
  }, {
    key: "isBetween",
    value: function isBetween(length, min, max) {
    ...
    value: function checkPhone() {
      var valid = false;
      var phone = this.phoneEl.value.trim();
    ...
    value: function checkAddress() {
      var valid = false;
      var address = this.addressEl.value.trim();
    ...
    value: function checkUsername() {
      ...
      if (!this.isRequired(username)) {
        ...
        this.showError(this.usernameEl, "\u0412 \u0438\u043C\u0435\u043D\u0438 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F \u0434\u043E\u043B\u0436\u043D\u043E \u0431\u044B\u0442\u044C \u043D\u0435 \u043C\u0435\u043D\u0435\u0435 ".concat(min, " \u0438 \u043D\u0435 \u0431\u043E\u043B\u0435\u0435 ").concat(max, " \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432"));
      } else {
    ...
    value: function validateForm($event) {
      ...
      var isUsernameValid = this.checkUsername(),
        isPhoneValid = this.checkPhone(),
        isAddressValid = this.checkAddress();
      var isFormValid = isUsernameValid && isPhoneValid && isAddressValid;
      if (isFormValid) {
